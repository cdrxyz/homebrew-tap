...
class Blastshield < Formula
  ...
  url "https://github.com/cdrxyz/blastshield/releases/download/v0.1.6/blastshield-0.1.6.tar.gz"
  version "0.1.6"
  sha256 "24dc73187ce0ed68a17402213abde818c1b96e351294def4d32363c4f0a5a793"
  license "Apache-2.0"
