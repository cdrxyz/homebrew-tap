...
class Blastshield < Formula
  ...
  url "https://github.com/cdrxyz/blastshield/releases/download/v0.1.3/blastshield-0.1.3.tar.gz"
  version "0.1.3"
  sha256 "f8bcb97b63d9d7f36a90e9ed82703f23e4f718bbd6b5371fce13e9342f96eb35"
  license "Apache-2.0"
